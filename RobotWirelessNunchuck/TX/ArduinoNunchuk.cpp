...
void ArduinoNunchuk::print()
{
  Serial.print(ArduinoNunchuk::analogX, DEC);
  Serial.print(' ');
  Serial.print(ArduinoNunchuk::analogY, DEC);
  Serial.print(' ');
  Serial.print(ArduinoNunchuk::accelX, DEC);
  Serial.print(' ');
  Serial.print(ArduinoNunchuk::accelY, DEC);
  Serial.print(' ');
  Serial.print(ArduinoNunchuk::accelZ, DEC);
  Serial.print(' ');
  Serial.print(ArduinoNunchuk::zButton, DEC);
  Serial.print(' ');
  Serial.println(ArduinoNunchuk::cButton, DEC);
}
